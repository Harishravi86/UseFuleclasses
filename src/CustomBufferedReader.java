...
public class CustomBufferedReader extends Reader {
     ...
     * this {@code CustomBufferedReader}.  The {@link Stream} is lazily populated,
     ...
     * {@code CustomBufferedReader}, it is wrapped in an {@link
     * UncheckedIOException} which will be thrown from the {@code Stream}
     * method that caused the read to take place. This method will return a
     * Stream if invoked on a CustomBufferedReader that is closed. Any operation on
     * that stream that requires reading from the CustomBufferedReader after it is
     * closed, will cause an UncheckedIOException to be thrown.
     *
     * @return a {@code Stream<String>} providing the lines of text
     * described by this {@code CustomBufferedReader}
     * @since 1.8
     */
